...
public class cavescreen : MonoBehaviour
{
    ...
    void Update()
    {
        Vector3 trf = topRightFront.transform.position - Quaternion.Euler(-cam.transform.rotation.eulerAngles.x, -cam.transform.rotation.eulerAngles.y, 0) * camrig.transform.position;
        Vector3 blb = bottomLeftBack.transform.position - Quaternion.Euler(-cam.transform.rotation.eulerAngles.x, -cam.transform.rotation.eulerAngles.y, 0) * camrig.transform.position;
