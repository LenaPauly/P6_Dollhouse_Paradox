This package currently is only tested for a Quest2 build, so this setup explains how to get it running for a Quest2 only. If you want to make it work for Vive etc, you may have to make your own XR Player rig. But this is independent from the Multiplayer parts of this application. Just make sure that the XRGrabInteractableNetwork script and the NetworkPlayer script works with your XRRig setup of choice.
